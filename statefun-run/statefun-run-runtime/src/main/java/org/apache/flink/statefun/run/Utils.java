...
final class Utils {
  ...
  public static final class HarnessRemoteMessage {
    ...
    public static Message ofUtf8String(
        String targetFunctionType, String targetFunctionId, String utf8Value) {
      return ofCustomType(
          targetFunctionType,
          targetFunctionId,
          "io.statefun.types/string",
          StringValue.of(utf8Value).toByteArray());
    }

    public static Message ofCustomType(
        String targetFunctionType, String targetFunctionId, String valueTypeUrl, byte[] value) {
      RoutingConfig.Builder config =
