...
public final class HttpServer {
  ...
  public static void serve(int port, StatefulFunctions functions) {
    ...
    // This example uses the Undertow HTTP server, but any other HTTP server (Jetty, Tomcat, Netty,
    // etc') will do:
  ...
  /**
   * A simple Undertow {@link HttpHandler} that delegates requests from StateFun runtime processes
   * to a StateFun {@link RequestReplyHandler}.
   */
