...
/** Representation of a Pulsar partition. */
public final class PulsarTopicPartition {

  private final String topic;
  private final int partition;

  public static PulsarTopicPartition fromString(String topicAndPartition) {
    ...
    return new PulsarTopicPartition(topic, partitionId);
  }

  public PulsarTopicPartition(String topic, int partition) {
  ...
  public String toString() {
    return "PulsarTopicPartition{" + "topic='" + topic + '\'' + ", partition=" + partition + '}';
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PulsarTopicPartition)) {
      return false;
    }

    PulsarTopicPartition that = (PulsarTopicPartition) o;
