...
//      producer.newMessage().key("k1").value("foo".getBytes()).send();
      ...
      final Consumer<String, InvokeResult> invokeResultConsumer = kafkaInvokeResultsConsumer(kafka.getBootstrapServers());
      final ConsumerRecords<String, InvokeResult> consumerRecords = invokeResultConsumer.poll(Duration.ofMillis(5000));
